...
subcellularvis_package <- install.packages(file.path("/fast/AG_Sugimoto/home/users/pallavi/Software_packages/R/subcellularvis"), repos = NULL, type = "source")
...
#Apply the 'extractCompartment' function to each  
