...
MQ_DI_noH2O_stoic_dt <- MQ_DI_noH20_stoic_dt[aa == "K"]
...
koh_wt_vs_KO_MQ_DI_noH2O_stoic_dt <- wt_vs_KO_MQ_DI_noH20_stoic_dt[ptm == "[Oxidation (K)]"]
...
```{r pnas2022_comparison_MQ_DI_noH20loss}
