---
title: "2-11. Lysine hydroxylations in varying O2 pc and dox induction time - excel data export"
...
This script exports processed lysine hydroxylation stoichiometry data for BRD protein sites to a formatted Excel sheet as part of the oxygen sensitivity analysis pipeline.
...
# 2.11.1 Install,load essential functions and libraries
...
# 2.11.2 Import human protein reference data 
...
# 2.11.3 MS_SS, MS_KR, PNAS Data tables converted to excel 
