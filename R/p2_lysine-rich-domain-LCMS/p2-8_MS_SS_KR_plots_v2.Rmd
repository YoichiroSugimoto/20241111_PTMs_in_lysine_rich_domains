...
# Subset WT data - N >= 0.1, relative to WT_stoichiometry 
...
# correlation test 
cor.test(c_MS_SS_KR_PNAS_dt[, iJ6_18h_21pc_SS], c_MS_SS_KR_PNAS_dt[, iJ6_18h_4pc_SS], method = "spearma")

wilcox.test(
  c_MS_SS_KR_PNAS_dt[, iJ6_18h_4pc_SS],
  c_MS_SS_KR_PNAS_dt[, iJ6_18h_21pc_SS],
  paired = TRUE
)
...
# correlation test 
cor.test(c_MS_SS_KR_PNAS_dt[, iJ6_18h_21pc_SS], c_MS_SS_KR_PNAS_dt[, iJ6_18h_1pc_SS], method = "spearma")
