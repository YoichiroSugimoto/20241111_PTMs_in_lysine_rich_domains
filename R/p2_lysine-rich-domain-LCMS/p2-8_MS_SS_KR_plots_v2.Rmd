...
# 2.7.4 Plotting Stoichiometry values of normoxia data with re-expression of JMJD6 
...
# 2.7.5 XIC values against MS_SS, MS_KR_1 and PNAS stoichiometry data. 
...
# 2.7.6 Oxygen sensitivity - Comparing hypoxia stoichiometry under varying dox incubation (+ diagnostic ion)
