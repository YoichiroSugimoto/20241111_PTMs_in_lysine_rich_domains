...
ggplot(
  data = lc_MS_SS_KR_PNAS_21pc_dt[induction != "Inf" & data_size_per_site == max(lc_MS_SS_KR_PNAS_21pc_dt[, data_size_per_site])],
  aes(
    x = induction,
    y = Stoichiometry
  )
...
# Boxplot - Stoichiometry of Dox + and - JMJD6 at 21pc O2
ggplot(
  data = lc_MS_SS_KR_PNAS_21pc_N01_dt[induction != "Inf" & data_size_per_site == max(lc_MS_SS_KR_PNAS_21pc_N01_dt[, data_size_per_site])],
  aes(
    x = induction,
    y = Stoichiometry
  )
