...
MQ_DI_stoic_K_dt <- PNAS_DI_all_stoic_dt[aa == "K"]

# removing unsed data columns from data table
MQ_DI_stoic_K_dt <-  MQ_DI_stoic_K_dt[, c("sum_intensity_per_position",
...
setnames(pnas2022_stoic_dt, c("stoichiometry", "protein_accession", "gene_name", "aa_pos"),  c("Stoichiometry_PNAS2022", "Protein_accession", "Gene_name", "Amino_acid_pos"))

# Merge MQ_DI stoic and pnas2022 by 'protein_accession' and 'aa_pos'
MQ_DI_stoic_K_dt <- merge(
  MQ_DI_stoic_K_dt,
  pnas2022_stoic_dt[, .(Gene_name, stoichiometry_PNAS2022, curated_oxK_site)],
  by = c("Protein_accession", "aa_pos")
)
