...
# Filter PNAS2022 MQ DI data to retain only BRD2, 3, 4 data 
pnas_DI_BRD_dt <-  pnas_DI_stoic_dt[
  gene_name %in% c("BRD2", "BRD3", "BRD4")
]

# Filter PNAS2022 manually curated sites to retain BRD2, 3, 4 data
pnas2022_curated_dt <- pnas2022_stoic_dt[
  Gene_name %in% c("BRD2", "BRD3", "BRD4")]
...
DI_sites <- rbind(
  ...
  pnas2022_curated_dt[ptm == "[Oxidation (K)]",  .(Protein_accession, Amino_acid_pos)]
)
