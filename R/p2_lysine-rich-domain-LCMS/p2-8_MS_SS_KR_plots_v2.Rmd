...
MQ_DI_stoic_dt <- read_stoic_data(
...
MQ_DI_BRD_dt <-  MQ_DI_stoic_dt[
  gene_name %in% c("BRD2", "BRD3", "BRD4")
]

# Combine MS_KR1_subset_dt and MS_SS_all_dt data
MS_SS_KR_MQ_dt <- rbindlist(list(MS_SS_BRD_dt,
                         MS_KR1_BRD_dt,
                         MQ_DI_BRD_dt),
                         use.names = TRUE)
...
MS_SS_KR_MQ_BRD2_dt <- MS_SS_KR_MQ_dt[grepl("Inf|0h|4h|8h|18h|24h", sample_group) & 
...
MS_SS_KR_MQ_BRD2_dt <-  MS_SS_KR_MQ_BRD2_dt[, sample_name := factor(
  sample_name, 
...
MS_SS_KR_MQ_BRD2 <- MS_SS_KR_MQ_BRD2_dt[is_diagnostic_peak == TRUE & aa == "K"]

# Write to csv table to identify "K" with DI 
fwrite(MS_SS_KR_MQ_BRD2, file.path(results.dir, "p2_MS_SS_KR", "MS_SS_KR_MQ_BRD2.csv"))
