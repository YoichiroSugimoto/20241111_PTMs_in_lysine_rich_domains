...
```{r stoichiometry_BRD_proteins_at_hypoxia_pc}
...
ggplot(
  data = lc_MS_SS_KR_PNAS_21pc_dt[oxygen == "21pc" & induction != "Inf" & data_size_per_site == max(lc_MS_SS_KR_PNAS_21pc_dt[, data_size_per_site])],
  aes(
    x = induction,
    y = Stoichiometry
  )
...
ggplot(
  data = lc_MS_SS_KR_PNAS_21pc_N01_dt[WT_stoichiometry >= 0.1 & oxygen == "21pc" & induction != "Inf" & data_size_per_site == max(lc_MS_SS_KR_PNAS_21pc_N01_dt[, data_size_per_site])],
  aes(
    x = induction,
    y = Stoichiometry
  )
