...
This script examines the oxygen sensitivity of lysine hydroxylations in BRD proteins and their respective sites. This script is for visualising the calculated stoichiometry. 
...
MS_SS_BRD_dt <-  MS_SS_stoic_dt[gene_name %in% c("BRD2", "BRD3", "BRD4") 
                                  & aa == "K"
