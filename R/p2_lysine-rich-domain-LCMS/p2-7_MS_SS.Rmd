...
#MS_SS_KR_hydroxy_dt <- MS_SS_KR_hydroxy_dt[, `:=`(
 # Stoic_diff = (Normoxia - Hypoxia_18h_1pc),
  #Stoic_diff1 = (Normoxia - Hypoxia_18h_4pc),
  #Stoic_diff2 = (Normoxia - Hypoxia_24h_0.1pc)
#)]
...
ggplot(
  ...
  labs(title = "Stoichiometry difference") +
  theme_classic()+
