...
MS_SS_KR_dt <- na.omit(MS_SS_KR_dt)
...
# Normoxia set at 0.1
MS_SS_KR_hydroxy_dt <- subset(MS_SS_KR_hydroxy_dt, Normoxia >= 0.1)
...
hydroxy_dt <- melt(MS_SS_KR_hydroxy_dt, id.vars = c("protein_accession", "aa_pos", "gene_name"),
                measure.vars = c("Normoxia"), 
                variable.name = "sample_name_1", value.name = "Normoxia_Stoic")
