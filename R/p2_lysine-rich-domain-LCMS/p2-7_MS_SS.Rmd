---
title: "2-7. Lysine hydroxylations in varying O2 pc and dox induction time"
...
This script examines the oxygen sensitivity of lysine hydroxylations in different BRD proteins and their respective sites in varying percentage of O2. 
...
long_c_MS_SS_KR_all_dt <-  long_c_MS_SS_KR_all_dt[, oxygen := factor(
  oxygen,
