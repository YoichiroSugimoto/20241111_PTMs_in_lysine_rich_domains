...
```{r alculate_stoichiometry_MS_KR_1}
...
plot_ptm_stoichiometry(
  MS_KR1_stoic_dt, accession = "O60885", plot_range = NA, all.protein.bs, sample_colors = NA
  )

plot_ptm_stoichiometry(
  MS_KR1_stoic_dt, accession = "O60885", plot_range = c(531, 581), all.protein.bs, sample_colors = NA
  ) + 
  

plot_ptm_stoichiometry(
  MS_KR1_stoic_dt, accession = "P25440", plot_range = c(540, 580), all.protein.bs, sample_colors = NA
  )


MS_KR1_stoic_dt[diagnostic_peak == "+"]


# Plot 
ggplot(
  data = MS_KR1_stoic_dt[gene_name == "BRD4" & diagnostic_peak == "+" & aa_pos == 537],
  aes(
    x = Oxygen_levels,
    y = stoichiometry,
  )
