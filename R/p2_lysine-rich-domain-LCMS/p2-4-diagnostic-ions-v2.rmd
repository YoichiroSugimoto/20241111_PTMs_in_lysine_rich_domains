...
#Test - Extract the sites with diagnostic ions
DI_sites <- MQ_DI_noH20_stoic_dt[diagnostic_peak == "+"][
  !duplicated(paste(genotype, protein_accession, aa_pos)), 
  .(genotype, protein_accession, aa_pos)
]

MQ_DI_noH20_stoic_dt[, DI_site :=
  paste(genotype, protein_accession, aa_pos) %in% 
  DI_sites[, paste(genotype, protein_accession, aa_pos)]
]

#checking 
MQ_DI_noH20_stoic_dt[DI_site == TRUE, uniqueN(paste(protein_accession, aa_pos))]

MQ_DI_noH20_stoic_dt[DI_site == TRUE, .N]
...
koh_wt_vs_KO_MQ_DI_noH20_stoic_dt[DI_site == TRUE & met_within_2 == "No",
                            uniqueN(paste(protein_accession, aa_pos)),
                            by = genotype]
