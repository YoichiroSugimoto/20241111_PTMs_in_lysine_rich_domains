...
MQ_DI_it_d.hydroxyK_dt[, `:=`(
  is_diagnostic_peak = diagnostic_peak == "+" # create a new column with diagnostic_peak, where presence of diagnostic peak is represented by "+"
)]
...
# This plot identifies lysine hydroxylations events in the absence of JMJD6a
ggplot(
  data = MQ_DI_it_d.hydroxyK_dt[order(is_diagnostic_peak)],
  aes(
    x = JMJD6KO,
