...
# 2.4.9 Comparison with previous PNAS 2022 paper - MQ_DI data
...
# MQ data including all hydroxylation sites (with and without DI)
...
# MQ data including all hydroxylation proteins (with and without DI)
...
# Count the total number of hydroxylation sites in MQ_DI (aa_pos)
