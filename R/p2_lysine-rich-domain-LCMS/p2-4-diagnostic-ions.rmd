...
# Count the total number of lysine hydroxylations in MQ_DI (aa_pos)
MQ_DI_noH2O_stoic_dt[diagnostic_peak == "+"][aa == "K"][ptm == "[Oxidation (K)]"][order(protein_accession, aa_pos, -diagnostic_peak)][!duplicated(paste(protein_accession, aa_pos))][, .N]

# create data table with hydroxylated sites 
MQ_DI_noH2O_site_count <- MQ_DI_noH2O_stoic_dt[diagnostic_peak == "+"][aa == "K"][ptm == "[Oxidation (K)]"][order(protein_accession, aa_pos, -diagnostic_peak)][!duplicated(paste(protein_accession, aa_pos))]
...
# Count the total number of lysine hydroxylations in MQ_DI (gene_name)
MQ_DI_noH2O_stoic_dt[diagnostic_peak == "+"][aa == "K"][ptm == "[Oxidation (K)]"][order(protein_accession, aa_pos, -diagnostic_peak)][!duplicated(paste(protein_accession, gene_name))][, .N]

# create data table with hydroxylated proteins
MQ_DI_noH2O_protein_count <- MQ_DI_noH2O_stoic_dt[diagnostic_peak == "+"][aa == "K"][ptm == "[Oxidation (K)]"][order(protein_accession, aa_pos, -diagnostic_peak)][!duplicated(paste(protein_accession, gene_name))]
...
ggVennDiagram(vennlist)+scale_fill_gradient(low = "#F4FAFE", high = "#4981BF")
