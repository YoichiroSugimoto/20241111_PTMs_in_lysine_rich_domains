...
# Count data per protein acession and aa position
...
# Keep only sites which are WT and stoichiomtery > 0 
...
# Boxplot - Stoichiometry versus induction times (normoxia condition)
ggplot(
...
# Create data table categorising 
