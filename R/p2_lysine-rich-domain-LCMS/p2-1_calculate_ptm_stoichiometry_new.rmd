...
# 2.1.7 Comparison - PNAS2022 versus new workflow for PSM coverage and stiochiometry
...
# Load MQ_DI stoichiometry data (m7_v7)
MQ_DI_stoic_dt <- fread(file.path(project.dir, "results",  "p2-analysis-setting/MQ_DI/DI_data-A_trp_m7_v7_def_PTM_stoichiometry.csv"))
